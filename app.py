...
if gdb_cargada:
    ...
    with tab2:
        ...
        # Normalizamos los índices para prevenir KeyErrors
        ...
        # ----------------------------------------------------------------------
        # EXTRACCIÓN MAESTRA (TODO DE ANALISIS_PARAMETRICO)
        # ----------------------------------------------------------------------
    ...
    # --------------------------------------------------------------------------
    # TAB 4: RIESGOS Y ESCALABILIDAD (Sincronizado y Estadísticamente Robusto)
    # --------------------------------------------------------------------------
    with tab4:
